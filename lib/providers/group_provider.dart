...
final StreamProviderFamily<bool, String> groupIsLikedProvider =
...
final StreamProviderFamily<bool, String> groupIsFavoritedProvider =
    StreamProvider.family<bool, String>((ref, groupId) {
  final uid = ref.watch(currentUserIdProvider);
  if (uid == null) return Stream.value(false);
...
// --- Curtir / Favoritar grupo (ação de UI) ---
